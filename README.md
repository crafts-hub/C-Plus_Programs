...
int main() {
    ...
    cout << a << ", " << b ; // prints first two terms, i.e: 0, 1

    for (int i = 3; i <= numOfTerms; i++) // (i = 3) means it starts from 3rd term because we alrady printed first two terms
    {
        // bellow is simple logic of swap tow numbers:
        int c = a + b; 
        a = b;
        b = c;
        cout << ", " << b ;
